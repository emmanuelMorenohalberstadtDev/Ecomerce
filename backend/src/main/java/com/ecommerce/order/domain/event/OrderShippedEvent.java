...
/**
 * Published after an {@code Order} transitions {@code CONFIRMED -> SHIPPED}
 * ({@code AdminShipOrderUseCase}) — rule 12.
 *
 ...
 */
public record OrderShippedEvent(OrderId orderId, CustomerId customerId, Instant occurredAt) {
